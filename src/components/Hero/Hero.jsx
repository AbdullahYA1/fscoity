...
const Hero = ({ isLoaded, scrollToSection }) => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative z-10 animate-on-scroll pt-5"
    >
      <div className="text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 animate-fade-in mb-16 sm:mb-20 md:mb-24">
            <button
